...
public class FirstSmsApplicationConfigurationTest {
    ...
    public void shouldSendSms() {
        log.info("Application context in first test: {}", applicationContext);
        notificationService.send("Hello from first test!");
    }
}
